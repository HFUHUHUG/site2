...
const shopsData = {
    "Мой магазин": [
        ...
        { id: "prot", name: "Книга: Защита (1-10)", type: "level", base: 3, step: 5, max: 10, enabled: true },
        ...
        // Зачеркнутые товары (по вашему ТЗ)
        { id: "looting", name: "Книга: Добыча (1-10)", type: "level", base: 5, step: 3, max: 10, enabled: false },
        { id: "fire_asp", name: "Книга: Заговор огня (1-10)", type: "level", base: 3, step: 2, max: 10, enabled: false }
    ],
    "Магазин Игрока_2": [
